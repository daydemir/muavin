...
function assertNoDeleteScript(script: string): void {
  if (/\bdelete\b/i.test(script)) {
    throw new Error("Blocked by policy: delete operations are disabled");
  }
}
